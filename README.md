...
> Windows porting is experimental. The replay/network layer and a native
> state-guided Windows fuzzer are in progress; full native coverage-guided
> `afl-fuzz.exe` support for Windows targets still requires a Windows coverage
> backend. See
> [docs/windows_port.md](docs/windows_port.md), including the optional Docker
> Desktop cross-build helper.
...
# Equivalent full network config form:
aflnet-replay $AFLNET/tutorials/live555/CVE_2019_7314.poc RTSP tcp://127.0.0.1/8554
```
